...
3) Microsoft Foundry + Azure AI Agent Service. Labelled as (azureaiagent.ipynb)
...
Follow the steps to creating a hub and project in Microsoft Foundry found here: [Hub resources overview](https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/ai-resources)
